...
\begin{figure}[ht]
	...
	\begin{minipage}[t][10cm][t]{0.5\textwidth}
		\begin{enumerate}	
			...
			\item \textbf{Enemies} - Enemies go next to the wheel, with the configuration described in the storybook
			...
			\item \textbf{Markers} - Various markers to track damage, Banes \& Boons etc..
		\end{enumerate}
...
After you beat encounters 1 and 2, you level up, as described on page \pageref{Section_CharacterBuilding}.
