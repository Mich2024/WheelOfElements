...
\begin{figure}[ht]
	...
	\begin{minipage}[t][8cm][t]{0.5\textwidth}
		...
		The text is separated into four sections. After reading a section, start one of the three fights. After finishing a fight, read the next section, draw an event  \textit{See Chapter \pageref{Section_Events}} and level up \textit{See Chapter \pageref{Section_CharacterBuilding}}. Repeat this process after finishing the second encounter.
		...
		After the first and second encounter, you level up. \textit{See Chapter \pageref{Section_CharacterBuilding}}
