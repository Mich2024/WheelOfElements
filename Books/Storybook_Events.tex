...
\begin{figure}[ht]
	...
	\begin{minipage}[t][8cm][t]{0.5\textwidth}
		...
		The text is separated into four sections. After reading a section, start the fight below that story section. After finishing a \textbf{fight}, read the next story section, draw an \textbf{event}  \textit{See Page \pageref{Section_Events}} and \textbf{level up} \textit{See Page \pageref{Section_CharacterBuilding}}. Repeat this process after finishing the second encounter.
		...
		These enemy setups are \textbf{distributed} in \textbf{clockwise} seating order. %Please get  a picture for this
...
\begin{figure}[ht]
	\begin{minipage}[t][6.5cm][t]{0.5\textwidth}
		After the first two encounters, your party will encounter events. These willchange how you play the rest of the story. All events have an  \textbf{upside} and a  \textbf{downside} which will affect your choices and gameplay.
