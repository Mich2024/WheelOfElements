...
\textbf{Power Focus} - All ancestries have \textbf{equal total power}, but they have very \textbf{different distributions} of that power. The icons indicate what the ancestry brings to the table, but do not signify exact equal power when compared to other ancestries.
...
\begin{tcolorbox}[colframe=blue, colback=white]
	Reminder -	The tableau provides an overview of all of the passives that affect you.
\end{tcolorbox}