...
\begin{tcolorbox}[colframe=red, colback=white]
	 Important - Track the actions of ABC enemies by placing a red enemy cube on their letter "A" at the start of combat. Move the cube down at the start of each turn.  When you reach the end, place the cube on "A" again.
\end{tcolorbox}		
