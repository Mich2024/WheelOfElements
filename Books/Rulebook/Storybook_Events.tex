...
\begin{figure}[ht]
	...
	\begin{minipage}[t][9cm][t]{0.5\textwidth}
		...
		The text is separated into four sections. After reading a section, start the \textbf{fight} below that story section. After finishing a fight, read the next story section, \textbf{level up} \textit{(See "Leveling Up", Page \pageref{Section_Leveling})}. Repeat this process after finishing the second encounter.
		...
		After the first and second encounter, you level up. \textit{(See "Leveling Up", Page \pageref{Section_Leveling})}
