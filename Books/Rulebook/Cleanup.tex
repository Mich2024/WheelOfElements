...
\begin{figure}[ht]
	\begin{minipage}[t][13cm][t]{0.5\textwidth}
		...
		\begin{itemize}
			\item \textbf{Boons \& Banes} - If relevant, apply poison damage and remove any single-turn boon or bane. \textit{(See "Boons \& Banes", on handout)} \\
			...
			\begin{tcolorbox}[colframe=blue, colback=white]
				Reminder - Clumping a lot of enemies on one person may lead to a swift death :)
			\end{tcolorbox}
	...
	\begin{minipage}[t][11cm][t]{0.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth, valign=t]{../ExplanationPics/Rota.drawio.png}
	\end{minipage}
\end{figure}
